...
using User = FinalExam.Core.Entities.User;
...
public class AccountController : Controller
{
    ...
    private readonly BL.Services.IEmailService _emailService;
    public AccountController(UserManager<User> userManager, SignInManager<User> signInManager, BL.Services.IEmailService emailService)
    {
